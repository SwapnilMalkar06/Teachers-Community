...
import { UserCheck, BookOpen, Plus, Trash2, Edit, Save, LogOut, FileText, Presentation, FileQuestion, RefreshCw, CheckCircle, AlertCircle, Sparkles } from 'lucide-react';
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-slate-900 border border-slate-800 p-6 rounded-3xl shadow-xl">
          ...
          <div className="flex items-center space-x-3">
            ...
            >
              ...
              <span>Upload Notes / PPT / Q-Bank</span>
            </button>
